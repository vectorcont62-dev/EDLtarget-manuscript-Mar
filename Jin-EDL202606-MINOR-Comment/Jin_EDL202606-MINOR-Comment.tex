...
In this response letter, there were a few clarifications in abstract, section \uppercase\expandafter{\romannumeral 3} and conclusion.

All corresponding changes have been incorporated into the revised manuscript andre highlighted in the marked revision manuscript.
The page and line numbers reported below refer to the \uline{marked revision manuscript}.
...
These concise additions place the essential convergence ranges in the main manuscript.
...
\hspace{40pt} \noindent \textit{Page\# and rough location in page: Line 5--14 and 47--53 at Page 3}
...
In Section~III, result now states that the present validation is limited to this calibrated cryogenic-emulation TCAD benchmark and does not establish either the absolute experimental cryogenic $\Delta V_\mathrm{th}$ magnitude or full device physics at 4.2~K.
The section \uppercase\expandafter{\romannumeral 4} conclusion was also revised to use the same calibrated cryogenic-emulation benchmark terminology.
...
\hspace{40pt} \noindent \textit{Page\# and rough location in page: Line 11 at Page 1; Line 24--25 and 38--43 at Page 3; Line 1--7 at Page 4}
