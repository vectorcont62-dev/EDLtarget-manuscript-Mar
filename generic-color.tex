...
\begin{document}
\title{Autonomous Physics-Based Modeling of Retention Loss in 3-D NAND Flash Memories}\author{Myung Jin, Haechan Choi, and Hyungcheol Shin, \IEEEmembership{Senior Member, IEEE}
\thanks{This paragraph of the first footnote will contain the date on 
which you submitted your paper for review. (\textit{Corresponding Author: Myung Jin; Hyungcheol Shin.}) }
\thanks{Myung Jin is with the Department of Electrical and Computer Engineering, Seoul National University, Seoul 08826, South Korea (e-mail: gsjb1028@snu.ac.kr).}
