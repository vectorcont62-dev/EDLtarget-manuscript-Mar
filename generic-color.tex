...
\begin{document}
\title{Autonomous Physics-Based Modeling of Retention Loss in Cryogenic 3-D NAND Flash}\author{Myung Jin, Haechan Choi, and Hyungcheol Shin, \IEEEmembership{Senior Member, IEEE}
...
The simulation was perfomed with virgin cell with program voltage of $1~\mu s$ applied to the target wordline.
To ignore lateral migration retention loss, neighboring data pattern was selected~\cite{Chou.IEDM2023}.

The variation of the $t_{ox}$ showed the most dominancy in detrapping time transient curve.
In Fig.~2 (b), $t_{ox}$ from 3~nm to 5~nm for both TCAD simulation and the model were perfomed, showing good match with each other.
