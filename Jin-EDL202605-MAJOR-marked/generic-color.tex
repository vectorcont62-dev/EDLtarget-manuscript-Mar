...
\hl{Both approaches showed a consistent retention-time trend in the extreme condition, as reflected in the calibrated TCAD curve in \hbox{Fig.~\ref{fig3}(a)}, indicating that the suppression of thermally activated transitions can reproduce the dominant cryogenic detrapping behavior.}
...
In the model calculation, the trap energy was divided into 100 bins, and the CTN layer was discretized into 30 slices\hl{, which were confirmed to be in the converged regime}.
