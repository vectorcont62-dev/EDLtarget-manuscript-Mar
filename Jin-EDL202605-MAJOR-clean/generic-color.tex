...
In the model calculation, the trap energy was divided into 100 bins, and the CTN layer was discretized into 30 slices{, which were confirmed to be in the converged regime}.
