...
The modeled profile in Fig.~2(b) was constructed to be consistent with the TCAD program result and previous TCAD-based radial charge-profile modeling studies.
